...
**What is exciting**
The testing structure provided in both frameworks is a key attractor.  Unit testing for both appears to be the same, based on Hadley's testthis library; Rhino additionally provides end-to-end testing using Cypress which Golem does not.  Rhino's other selling point is integrated github CI which includes e.g. linting.
Rhino
```
shiny::runApp()
```
